...
class CategoryAdapter(
    var models: ArrayList<CategoryModel>,
    var context: Context,
) : RecyclerView.Adapter<CategoryAdapter.AdapterViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterViewHolder {
        v = LayoutInflater.from(parent.context).inflate(R.layout.category_item, parent, false)
        return AdapterViewHolder(v)
    }

    override fun onBindViewHolder(holder: AdapterViewHolder, position: Int) {
        val item = models[position]
        holder.text.setText("${models.get(position).contents}")
